...
<?php endif; ?>
            ...
            <section class="form-section">
                ...
                <form action="index.php" method="post" class="car-form">
                    ...
                    <input type="number" name="Asking_Price" placeholder="Asking Price (Whole Dollars Only)" value="<?php echo (int)($edit_car['ASKING_PRICE'] ?? ''); ?>" step="1" title="Please enter a whole dollar amount." required>                
            <!-- New From Info -->
